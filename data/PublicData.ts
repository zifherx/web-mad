...
export const MenuItemsSidebar: IMenuSidebar[] = [
  {
    id: 1,
    slug: "dashboard",
    label: "Dashboard",
  ...
  },
  {
    ...
    hasSubmenu: true,
    submenu: [
      { id: 1, slug: "/contenido/articulos", label: "Artículos/Blog" },
      {
        id: 2,
        slug: "/contenido/nuevo-articulo",
        label: "Nuevo artículo",
        icon: Plus,
      },
      { id: 3, slug: "/contenido/paginas", label: "Páginas" },
      { id: 4, slug: "/contenido/categorias", label: "Categorias" },
      { id: 5, slug: "/contenido/recursos", label: "Recursos Descargables" },
    ],
  },
  {
    id: 3,
    ...
    hasSubmenu: true,
    submenu: [
      { id: 1, slug: "/servicios/conferencias", label: "Conferencias" },
      {
        id: 2,
        slug: "/servicios/marketing-estrategico",
        label: "Marketing Estratégico",
      },
      { id: 3, slug: "/servicios/desarrollo-web", label: "Desarrollo Web" },
      {
        id: 4,
        slug: "/servicios/customer-experience",
        label: "Customer Experience",
      },
      {
        id: 5,
        slug: "/servicios/nuevo-servicio",
  ...
  },
  {
    ...
    hasSubmenu: true,
    submenu: [
      { id: 1, slug: "/equipo/miembros", label: "Miembros del Equipo" },
      {
        id: 2,
        slug: "/equipo/agregar-miembro",
        label: "Agregar-miembro",
        icon: Plus,
      },
      { id: 3, slug: "/equipo/roles", label: "Roles y permisos" },
      { id: 4, slug: "/equipo/expertos", label: "Miembros del Equipo" },
    ],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    hasSubmenu: true,
    submenu: [
      { id: 1, slug: "/eventos/webinars", label: "Webinars" },
      {
        id: 2,
        slug: "/eventos/conferencias-presenciales",
        label: "Conferencias presenciales",
      },
      { id: 3, slug: "/eventos/workshops", label: "Workshops" },
      {
        id: 4,
        slug: "/eventos/crear-evento",
        label: "Crear evento",
        icon: Plus,
      },
    ],
  },
  {
    ...
    hasSubmenu: true,
    submenu: [
      { id: 1, slug: "/marketing/email-marketing", label: "Email Marketing" },
      { id: 2, slug: "/marketing/suscriptores", label: "Suscriptores" },
      { id: 3, slug: "/marketing/lead-generation", label: "Lead Generation" },
      { id: 4, slug: "/marketing/seo", label: "SEO" },
    ],
  },
  {
    id: 9,
    ...
    hasSubmenu: true,
    submenu: [
      { id: 1, slug: "/diseno/media", label: "Media Library" },
      { id: 2, slug: "/diseno/banners", label: "Banners/Sliders" },
      { id: 3, slug: "/diseno/galeria", label: "Galeria" },
    ],
  },
  {
    id: 10,
  ...
  },
  {
    ...
    hasSubmenu: true,
    submenu: [
      { id: 1, slug: "/configuracion/general", label: "General" },
      { id: 2, slug: "/configuracion/usuarios", label: "Usuarios" },
      { id: 3, slug: "/configuracion/integraciones", label: "Integraciones" },
      { id: 4, slug: "/configuracion/seguridad", label: "Seguridad" },
    ],
  },
];

export const IndicatorDashboardList: ICardStatIndicator[] = [
  {
    id: 1,
    titleDescription: "Total Revenue",
    titleValue: 1250,
    typeValue: "CURRENCY",
    badge: "+12.5%",
  ...
  {
    id: 2,
    titleDescription: "New Customers",
    titleValue: 1234,
    typeValue: "NUMBER",
    badge: "-20%",
  ...
  {
    id: 3,
    titleDescription: "Active Accounts",
    titleValue: 45678,
    typeValue: "NUMBER",
    badge: "+12.5%",
    iconBadge: TrendingUp,
  ...
  {
    id: 4,
    titleDescription: "Growth Rate",
    titleValue: 4.5,
    typeValue: "PERCENT",
    badge: "+4.5%",
    iconBadge: TrendingUp,
    footerTitle: "Steady perfomance increase",
...
export const COLOR_VARIANTS_DATA = {
  red: {
    gradient: "from-[oklch(0.66_0.2285_22.3)] to-[oklch(0.71_0.1829_35.86)]",
    bg: "bg-[oklch(0.66_0.2285_22.3)]/10",
    text: "text-[oklch(0.66_0.2285_22.3)]",
    border: "border-[oklch(0.66_0.2285_22.3)]/20",
    badgeBg: "bg-[oklch(0.66_0.2285_22.3)]/10",
    iconBg: "bg-[oklch(0.66_0.2285_22.3)]/15",
  },
  orange: {
    gradient: "from-[oklch(0.71_0.1829_35.86)] to-amber-500",
    bg: "bg-[oklch(0.71_0.1829_35.86)]/10",
    text: "text-[oklch(0.71_0.1829_35.86)]",
    border: "border-[oklch(0.71_0.1829_35.86)]/20",
    badgeBg: "bg-[oklch(0.71_0.1829_35.86)]/10",
    iconBg: "bg-[oklch(0.71_0.1829_35.86)]/15",
  },
  blue: {
